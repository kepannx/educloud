...
<div id="page-wrapper"<?php if ($template['page_preloader']) { echo ' class="page-loading"'; } ?>>
    ...
    <div class="preloader themed-background">
        <h1 class="push-top-bottom text-light text-center"><strong>Edu</strong>Cloud</h1>
        <div class="inner">
    ...
    <div id="page-container"<?php if ($page_classes) { echo ' class="' . $page_classes . '"'; } ?>>
            ...
            <div id="sidebar-scroll">
                ...
                <div class="sidebar-content">
                    ...
                    <a href="<?php echo BASEPATH; ?>index.php" class="sidebar-brand">
                        <i class="gi gi-cloud"></i><span class="sidebar-nav-mini-hide"><strong>Edu</strong>Cloud</span>
                    </a>
                    <!-- END Brand -->
                    ...
                    <div class="sidebar-section sidebar-user clearfix sidebar-nav-mini-hide">
                        <div class="sidebar-user-avatar">
                            <a href="page_ready_user_profile.php">
                                <img src="<?php echo BASEPATH; ?>img/placeholders/avatars/avatar2.jpg" alt="avatar">
                            </a>
                        </div>
        ...
        <div id="main-container">
            ...
            <header class="navbar<?php if ($template['header_navbar']) { echo ' ' . $template['header_navbar']; } ?><?php if ($template['header']) { echo ' '. $template['header']; } ?>">
                ...
                <!-- Search Form -->
                <form action="resultadosBusqueda.php" method="post" class="navbar-form-custom">
                    <div class="form-group">
                        <input type="text" id="top-search" name="top-search" class="form-control" placeholder="Qué Buscas?..">
                    </div>
                </form>
                <!-- END Search Form -->
